...
#    - work with conda environment created using uniq.opt.env.yaml (tensorflow 2.3.x)
#
#  V1.x :  ppoTF2 modified by yjlee (v20230309)
#    - work with conda environment created using uniq.opt.env.yaml (tensorflow 2.3.x)
#
#  V2 :  ppoTF2 modified by yjlee (v20230412)
#   - work with conda environment created using uniq.opt.v2.env.yaml
#     (tensorflow 2.6.x, keras 2.6.x)
#
#
# ================================================================
import argparse
...
class CriticModel:
    ...
    def save_weights(self, fn_prefix, num_id):
        ...
        for i, model in enumerate(self.models):
            model.save_weights(f"{fn_prefix}_{num_id}_critic_{i}.h5") # org
...
class PPOAgentTF2:
    ...
    def gaussian_likelihood(self, action, pred, log_std):
        ...
        # print(f"type(log_std)={type(log_std)} log_std={log_std}")  ## should DELETE
