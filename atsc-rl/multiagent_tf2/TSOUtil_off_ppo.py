...
from TSOConstants_off_ppo import _MODE_
from TSOConstants_off_ppo import _MSG_TYPE_
...
def addArgumentsToParser(parser):
    ...
    parser.add_argument('--action', choices=['kc', 'offset', 'gr', 'gro', 'gt', 'fx'], default='offset',
    ...
    ### PPO Replay Memory
    parser.add_argument('--mem-len', type=int, default=512, help='memory length')
